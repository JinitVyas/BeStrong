        ...
        <div className="flex justify-center space-x-10">
          <div className="bg-gray-900 p-8 rounded-lg shadow-lg">
            ...
            <p className="text-4xl font-bold mt-4">
              ₹23.99 <span className="text-lg">/ month</span>
            </p>
            <ul className="mt-4">
            ...
            <button className="bg-lime-400 text-black font-semibold py-2 px-6 mt-6 rounded-md">
              Choose Plan
            </button>
          </div>
          <div className="bg-gray-900 p-8 rounded-lg shadow-lg">
          ...
          <div className="bg-gray-900 p-8 rounded-lg shadow-lg">
            ...
            <p className="text-4xl font-bold mt-4">
              ₹89.99 <span className="text-lg">/ month</span>
            </p>
            <ul className="mt-4">
